...
var _defaultMinCss = require("vanilla-icon-picker/dist/themes/default.min.css");
...
form.addEventListener("submit", (event)=>{
    ...
    if (input.value.length === 0) {
        (0, _notiflixDefault.default).Notify.failure(`Enter some task please.`);
        return;
    }
    ...
    (0, _notiflixDefault.default).Notify.success(`Task: "${task_el.children[1].children[0].value}" added.`);
    input.value = "";
    task_edit_el.addEventListener("click", (event)=>{
        if (task_edit_el.innerText.toLowerCase() == "edit") {
            ...
            task_edit_el.innerText = "Edit";
            task_input_el.readOnly = true;
            (0, _notiflixDefault.default).Notify.warning("Task edited.");
        }
    });
...
trash.addEventListener("click", ()=>{
    (0, _notiflixDefault.default).Confirm.show("Remove all tasks", "Do you want to remove all tasks?", "Yes", "No", function okCb() {
        list_el.innerText = "";
        trash.classList.add("is-hidden");
        (0, _notiflixDefault.default).Notify.failure(`All tasks removed.`);
    }, function cancelCb() {
        return;
    }, {
        width: "320px",
